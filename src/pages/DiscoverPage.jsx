...
const DiscoverPage = () => {
  return (
    /* 🔹 OUTER WRAPPER — FULL SCREEN GRADIENT */
    <div
      style={{
        minHeight: "100vh",
        background:
      ...
      >
        ...
        >
          <p style={{ color: "var(--text-secondary)", lineHeight: "1.6" }}>
            ...
            Announcements are analyzed, categorized, and published here for
            easier discovery.
          </p>
        ...
        >
          ...
          <button className="btn-secondary">Scholarships</button>
          <button className="btn-secondary">Tournaments</button>
          <button className="btn-secondary">Trials</button>
        </div>
        ...
        >
          ...
          <p style={{ color: "var(--text-secondary)", margin: "1rem 0" }}>
            Create an account to save opportunities and apply directly.
          </p>
